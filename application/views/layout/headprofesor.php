                        ...
                        <li class="dropdown notification-list topbar-dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end profile-dropdown ">
                                ...
                                <span id="txt_nombre" style="font-size: 11px;"></span>
                                    ...
                                    <!-- item-->
                                <a href="editarprofesor" class="btn_account dropdown-item notify-item">
                                    <i class="fe-user"></i>
...
<!-- Servidesk -->
                    ...
                    <!-- item-->
                    <a href="<?php echo base_url('principalprofesor') ?>" class="dropdown-item">
                                    <i class="mdi mdi-archive-arrow-down"></i> &nbsp
                                    <span>Página Principal</span>
                                </a>

                                <!-- item-->
                                <a href="<?php echo base_url('editarprofesor') ?>" class="dropdown-item">
                                    <i class="fe-user"></i> &nbsp
                                    <span>Perfil</span>
                                </a>
                                <a href="<?php echo base_url('cursoprofesor') ?>" class="dropdown-item">
                                    <i class="mdi mdi-archive-arrow-down"></i> &nbsp
                                    <span>Cursos</span>
                                </a>
